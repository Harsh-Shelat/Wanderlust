...
<title>Wanderlust Airways</title>
...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/Carousel0.jpg" alt="travel1" width="1200"
					height="700">
			</div>
			<div class="item">
				<img src="images/Carousel1.jpg" alt="travel2" width="1200"
					height="700">
			</div>

			<div class="item">
				<img src="images/Carousel2.jpg" alt="travel3" width="1200"
					height="700">
			</div>

			<div class="item">
				<img src="images/Carousel3.jpg" alt="Travel4" width="1200"
					height="700">
			</div>
			<div class="item">
				<img src="images/Carousel4.jpg" alt="Travel5" width="1200"
					height="700">
			</div>
		</div>
								...
								<div class="col-md-6 control-label">
									<div class="col-md-3">
										<div class="input-group date" data-provide="datepicker">
											<span class="input-group-addon"><i
												class="fa fa-calendar"></i></span> <input type="text"
												placeholder="Flight Date" id="flightdate" />
										</div>
									</div>
								</div>
	...
	<div id="specialoffer">
		<ul>
			<li><img src="images/offer1.jpg" alt="travel1" width="2000"
				height="700"></li>
			<li><img src="images/offer2.jpg" alt="travel2" width="2000"
				height="700"></li>
			<li><img src="images/offer3.jpg" alt="travel3" width="2000"
				height="700"></li>
			<li><img src="images/offer4.jpg" alt="travel4" width="2000"
				height="700"></li>
			<li><img src="images/offer5.jpg" alt="travel5" width="1350"
				height="700"></li>
			<li><img src="images/offer6.jpg" alt="travel6" width="1500"
				height="700"></li>
			<li><img src="images/offer7.jpg" alt="travel7" width="1500"
				height="700"></li>
			<li><img src="images/offer8.jpg" alt="travel8" width="1500"
				height="700"></li>
			<li><img src="images/offer9.jpg" alt="travel9" width="1400"
				height="700"></li>
			<li><img src="images/offer11.jpg" alt="travel11" width="1500"
				height="700"></li>
			<li><img src="images/offer12.jpg" alt="travel12" width="2000"
				height="700"></li>
	...
	<div id="aboutus" class="bg-1">
		<div class="container text-center">
			...
			<p>
				<em>Experience the sky life</em>
			</p>
			<p>Wanderlust airways started in 2016, allows you to reach your
				dream destinations. Our world's biggest fleets of Airbus A380s and
				Boeing 777s offering our customers the comfort of latest and most
				efficient wide body aircrafts in the skies. We inspire the travels
				around the world with our growing network of worldwide destinations,
				industry leading inflight entertainment, regionally inspire cuisine
				and world class service. With a fleet of more than 250 aircraft, we
				fly over 150 destination in more than 30 countries around the world
				and our network is expanding constantly. Along with safety we
				provide the superior in flight experience.</p>
			<br>
		</div>
		<br>
		<!-- Footer -->
